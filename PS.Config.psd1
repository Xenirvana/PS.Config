#
# Module manifest for module 'PS.Config'
#
# Generated by: SilentCryptographer
#
...
@{
    ...
    RootModule           = 'PS.Config.psm1'

    ModuleVersion        = '0.7.1'

    CompatiblePSEditions = @('Core')

    GUID                 = '5928123d-46e1-4d27-8776-acefd6c6d43c'
    ...
    FunctionsToExport    = @("Import-Configuration")
